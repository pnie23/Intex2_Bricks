...
namespace Intex2_Bricks.Migrations.Bricks
{
    ...
    [Migration("20240411180008_Initial10")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Intex2_Bricks.Models.IBRecommendation", b =>
                {
                    ...
                    b.HasIndex("Recommended_Product_1_ID");

                    b.HasIndex("Recommended_Product_2_ID");

                    b.HasIndex("Recommended_Product_3_ID");

                    b.HasIndex("Recommended_Product_4_ID");
            ...
            modelBuilder.Entity("Intex2_Bricks.Models.IBRecommendation", b =>
                {
                    b.HasOne("Intex2_Bricks.Models.Product", "RecommendedProduct1")
                        .WithMany()
                        .HasForeignKey("Recommended_Product_1_ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Intex2_Bricks.Models.Product", "RecommendedProduct2")
                        .WithMany()
                        .HasForeignKey("Recommended_Product_2_ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Intex2_Bricks.Models.Product", "RecommendedProduct3")
                        .WithMany()
                        .HasForeignKey("Recommended_Product_3_ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Intex2_Bricks.Models.Product", "RecommendedProduct4")
                        .WithMany()
                        .HasForeignKey("Recommended_Product_4_ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("RecommendedProduct1");

                    b.Navigation("RecommendedProduct2");

                    b.Navigation("RecommendedProduct3");

                    b.Navigation("RecommendedProduct4");
                });
