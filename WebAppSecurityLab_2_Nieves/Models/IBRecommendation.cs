...
namespace Intex2_Bricks.Models
{
    public class IBRecommendation
    {
        ...
        public string? Recommended_Product_1_ID { get; set; }
        ...
        public string? Recommended_Product_2_ID { get; set; }
        ...
        public string? Recommended_Product_3_ID { get; set; }
        ...
        public string? Recommended_Product_4_ID { get; set; }
